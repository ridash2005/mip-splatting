...
\begin{itemize}[leftmargin=1.4em,itemsep=3pt]
  ...
  \item \textbf{The \S3 diff check.} The 3DGS arm must differ from the Mip-Splatting arm by exactly the
...
\begin{itemize}[leftmargin=1.4em,itemsep=3pt]
  \item \texttt{r3\_real} is the largest single session and did not complete. It
        ...
        estimated.
  \item The arm-B re-runs after the opacity-compensation fix --- \texttt{c2\_armb} and its continuations
