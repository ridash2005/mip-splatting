...
and what it is made of. The rest of the thesis argues that the floor should be a
matrix rather than a number, and measures what happens when you make it one.}
...
\begin{figure}[htbp]
  ...
  the whole image and the reconstruction does not merely blur; it brightens and
  thickens, which is exactly what Figure~\ref{fig:ladder} shows happening to a
  real scene.}
  \label{fig:aliasing}
\end{figure}
...
\begin{figure}[htbp]
  ...
  carrying a colour and an opacity. To render it, the ellipsoid is projected to
  an ellipse on the image plane, which is what the EWA transform of
  Equation~\eqref{eq:ewa} does. Many such ellipses are then blended into each
