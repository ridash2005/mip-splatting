\chapter{Experimental design: one codebase, four configurations, gates fixed in advance}
\label{ch:design}
...
\section{The compute envelope, and which experiments it rules out}
...
\section{Why every configuration runs from a single codebase}
...
\section{The ladder of runs, and the exit criterion for each}
\begin{table}[htbp]
  \centering
...
\section{The stress suite: six capture protocols of decreasing parallax}
\label{sec:stress}
...
capture the prediction was made for, and the prediction must then be re-evaluated at the span that was built.

\input{generated/table-protocols}

\section{Three instruments that measure the capture itself}
...
\section{Metrics, controls, and how many seeds}
