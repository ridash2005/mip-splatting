...
frequency present in the sampled input images''. The instinct is exactly right.
...
model is evaluated at the resolution it was fitted at, this does no visible
harm, and that is precisely why it went unnoticed for so long. Change the
