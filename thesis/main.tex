...
\part{Problem}
\input{ch01-capture-limited-resolution}
\input{ch02-splatting-and-band-limits}
\input{ch03-scalar-limitations}

\part{Method}
\input{ch04-anisotropic-band-limit}
\input{ch05-angular-identifiability}
