...
Take the simplest case that still has something to say: two cameras at the same
distance $z$, placed symmetrically about the primitive, so that the angle
...
Notice that these are three distinct numbers, not two. The right filter is
therefore triaxial rather than merely elongated along depth: the lateral
