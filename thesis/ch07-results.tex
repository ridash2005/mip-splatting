...
from Gaussian Opacity Fields, which splits on a quantile over accumulated
gradient magnitudes rather than on a fixed gradient threshold. The original
...
two files --- which puts the code back in the state Mip-Splatting's published
table was produced from. Arm A was re-run on it, all
