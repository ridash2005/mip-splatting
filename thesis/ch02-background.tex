...
and what it is made of. The rest of the thesis argues that the floor should be a matrix and not a number, and measures what happens when you make it one.}
...
\begin{figure}[htbp]
  ...
  the whole image and the reconstruction does not merely blur; it brightens and thickens, which is what Figure~\ref{fig:ladder} shows happening
  to a real scene.}
  \label{fig:aliasing}
\end{figure}
