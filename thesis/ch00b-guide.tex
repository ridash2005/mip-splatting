...
carries the derivations in full, for a reader who wants to check the algebra
rather than accept the results. Appendix~\ref{app:harness} describes the machinery
...
Appendix~\ref{app:impl} gives the implementation: four configurations of one
codebase, and exactly what each switch touches. Appendix~\ref{app:defects} is the
...
provably, and that is the intended behaviour rather than a disappointment. Its
