...
\begin{center}
  ...
  \begin{tabular}{r@{\hspace{8pt}}l}
    ...
    \color{ink2}\footnotesize Version   & v3 \textperiodcentered\ \today\\
    \color{ink2}\footnotesize Status    & Theory complete \textperiodcentered\ five rungs measured \textperiodcentered\ both methods implemented\\
  \end{tabular}
  \vfill
\end{center}
\clearpage
