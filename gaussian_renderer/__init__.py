...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, kernel_size: float, scaling_modifier = 1.0, override_color = None, subpixel_offset=None):
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        # C1. False keeps the dilation and drops the opacity compensation,
        # which at kernel_size=0.3 is vanilla 3DGS. True is Mip-Splatting.
        mip_compensation=not getattr(pc, "_disable_2D_mip_compensation", False),
    ...
    rotations = None
    cov3D_precomp = None
    if getattr(pc, "use_fisher_filter", False):
