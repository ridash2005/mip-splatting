...
\begin{center}
  ...
  \begin{tabular}{r@{\hspace{8pt}}l}
    ...
    \color{ink2}\footnotesize Status    & Complete \textperiodcentered\ both baselines reproduced \textperiodcentered\ both methods measured\\
  \end{tabular}
  \vfill
\end{center}
\clearpage
...
\input{ch10-appendix}
\input{ch11-app-harness}
\input{ch12-app-impl}
\input{ch13-app-defects}
